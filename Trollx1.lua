...
game.StarterGui:SetCore("SendNotification", {
    Title = "لحظه من فضلك";
    Text = "سكربت المطورين TrollX"; -- ARAB TEAM
    Duration = 5;
})

wait(0.1)
game.StarterGui:SetCore("SendNotification", {
    Title = "☑⚜تمت برمجة السكربت من قبل TrollX⚜☑";
    Text = "☑⚜تم تفعيل سكربت TrollX⚜☑"; -- ARAB TEAM
    Duration = 5;
})
local args = {
    [1] = "RolePlayBio",
    [2] = "☑⚜سكربت المطور TrollX⚜☑"
}
...
loadstring(game:HttpGet(("https://qu.ax/RlPMk")))()
MakeWindow({
  Hub = {
    Title = "TrollX-HUB-Script",
    Animation = "SCRPIT TrollX Hub"
  },
  Key = {
    KeySystem = false,
    Title = "Key System",
...
MinimizeButton({
  Image = "rbxassetid://129498675864273",
  Size = {40, 40},
  Color = Color3.fromRGB(15, 15, 15),
  Corner = true,
  Stroke = true,
  StrokeColor = Color3.fromRGB(240, 240, 240)
})
...
local Paragraph = AddParagraph(Main, {"⚜️تفيدك ذني السوالف⚜️"})
AddButton(Main, {
...
local Main = MakeTab({Name = "⚜️السكربتات⚜️"})
AddButton(Main, {
  Name = "سكربت الجودة",
  Callback = function()
...
AddButton(Main, {
  Name = "⚜️سكربت المطور TrollX⚜️",
  Callback = function()
    local args = {
    [1] = "RolePlayBio",
    [2] = "⚜️سكربت المطور TrollX⚜️"
}
...
AddButton(Main, {
  ...
  Callback = function()
    local args = {
    [1] = "RolePlayBio",
    [2] = "⚜️فـًًٍٍُٓهـٍُٰٰوٍٍّدٍُُٰيًًٰ؟⚜️"
}
...
local Main = MakeTab({Name = "⚜الرحمه⚜"})
...
AddTextBox(Main, {
    Name = "ادخال اول 3 أحرفمن اسم الشخص",

Default = "",
    PlaceholderText = "ادخال اسم الشخص",
    ClearText = true,
    Callback = function(value)
        if value == "" then
            MakeNotifi({
